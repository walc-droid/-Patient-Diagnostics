                            ...
                            <table class="highlight centered responsive-table">
                                ...
                                <c:forEach items="${visit}" var="vs">
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Modal Trigger -->
                                            <a class="modal-trigger tooltipped" href="#modal${vs.id}"
                                               data-position="bottom"
                                               data-tooltip="delete"><i class="material-icons">delete</i></a>
                                            <!-- Modal Structure -->
                                            <div id="modal${vs.id}" class="modal">
                                                <div class="modal-content">
                                                    <h6>Are you sure to delete
                                                        visit for ${vs.patient.name} ${vs.patient.surname}?</h6>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="/visit/delete/${vs.id}"
